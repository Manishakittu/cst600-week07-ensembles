...
cst600-week07-ensembles/ │ ├── README.md ├── requirements.txt ├── .gitignore │ ├── src/ │   ├── data_load.py │   ├── preprocess.py │   ├── base_tree.py │   ├── bagging.py │   ├── boosting.py │   ├── evaluate.py │   └── main.py │ ├── figures/ │   ├── confusion_matrix_base_tree.png │   ├── confusion_matrix_bagging.png │   └── confusion_matrix_boosting.png │ ├── ppt/ │   └── ensemble_diagnosis.pptx │ └── video/ └── ensemble_briefing.mp4
